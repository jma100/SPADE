...
class MergeTrainer():
    ...
    def __init__(self, opt, obj_optimizer_G, obj_optimizer_D, global_optimizer_G, global_optimizer_D):
        self.opt = opt
    ...
    def run_object_generator_one_step(self, data):
        self.optimizer_G_object.zero_grad()
        object_g_losses, object_generated = self.merge_model.net_object(data, mode='generator')
    ...
    def run_object_discriminator_one_step(self, data):
        ...
        object_d_losses = self.merge_model.net_object(data, mode='discriminator')
    ...
    def run_global_generator_one_step(self, data):
        self.optimizer_G_global.zero_grad()
        global_g_losses, global_generated = self.merge_model.net_global(data, mode='generator')
    ...
    def run_global_discriminator_one_step(self, data):
        ...
        global_d_losses = self.merge_model.net_global(data, mode='discriminator')
